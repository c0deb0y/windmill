...
public class AlarmReportDialog extends JDialog implements ActionListener , Printable, Runnable {

	private AlarmReportTable table;
	private ResultSet alarmSet;
	private JButton btnNext;
	private JButton btnPrevious;
	private WaitDialog waitDlg=null;

	private TimePeriodValues datasetGust;
	private TimePeriodValues datasetHigh;
	private TimePeriodValues datasetHigher;
	 ...
	 * Create the dialog.
	 */
	public AlarmReportDialog(JFrame owner, String title, boolean modal, ResultSet alarmSet,
			...
			TimePeriodValues datasetHigher) {
				...
				this.datasetGust=datasetGust;
				this.datasetHigh=datasetHigh;
				this.datasetHigher=datasetHigher;
	...
	private void initialize() {
		...
		table = new AlarmReportTable(alarmSet, datasetGust, datasetHigh, datasetHigher);
